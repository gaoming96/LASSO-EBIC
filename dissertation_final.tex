...
\expandafter\def\csname CTEX@spaceChar
...
% 中文封面内容(关注内容而不是形式)
\title{分类方法在新加坡眼科数据中的应用}
\author{高\quad{}明}
\advisor{罗珊}
\degree{学士}
\defenddate{2018年5月16日}
\school{上海交通大学}
\institute{致远学院}
\studentnumber{5140719076}
\major{数学与应用数学(致远荣誉计划)}

% 英文封面内容(关注内容而不是表现形式)
\englishtitle{Application of statistical classification in Singapore  Eye Study}
\englishauthor{\textsc{Ming Gao}}
\englishadvisor{Prof. \textsc{Shan Luo}}
\englishschool{Shanghai Jiao Tong University}
\englishinstitute{\textsc{School of Mathematical Science} \\
  \textsc{Shanghai Jiao Tong University} \\
  \textsc{Shanghai, P.R.China}}
\englishdegree{Bachelor}
\englishmajor{Mathematics \& Applied Mathematics (Zhiyuan Honors Program)}
\englishdate{May. 16th, 2018}
